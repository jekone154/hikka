...
@loader.tds
class HikkaWebMod(loader.Module):
    """Web/Inline mode add account"""

    strings = {"name": "HikkaWeb"}
        ...
        if "JAMHOST" in os.environ:
            ...
            if "LAVHOST" in os.environ:
                form = await self.inline.form(
                    ...
                    photo="https://raw.githubusercontent.com/hikariatama/assets/refs/heads/main/hikka/web_interface.png",
                )
                return
            ...
            if not main.hikka.web:
                ...
                await main.hikka.web.add_loader(
            ...
            if force:
                ...
                await form.edit(
                    ...
                    photo=(
                        "https://raw.githubusercontent.com/hikariatama/assets/refs/heads/main/hikka/opening_tunnel.png"
                    ),
                )
            else:
                form = await self.inline.form(
            ...
            await form.edit(
                ...
                photo="https://raw.githubusercontent.com/hikariatama/assets/refs/heads/main/hikka/tunnel_opened.png",
            )
    ...
    def _get_client(self) -> CustomTelegramClient:
        return CustomTelegramClient(
            MemorySession(),
            main.hikka.api_token.ID,
            main.hikka.api_token.HASH,
            connection=main.hikka.conn,
            proxy=main.hikka.proxy,
    ...
    async def schedule_restart(self, call, client):
        ...
        await main.hikka.save_client_session(client, delay_restart=False)
        restart()
