...
class Presets(loader.Module):
    ...
    async def _menu(self):
        ...
        await self.inline.bot.send_photo(
            self._client.tg_id,
            "https://raw.githubusercontent.com/hikariatama/assets/refs/heads/main/hikka/presets_cmd.png",
    ...
    async def presets(self, message: Message):
        ...
        await self.inline.form(
            message=message,
            photo="https://raw.githubusercontent.com/hikariatama/assets/refs/heads/main/hikka/presets_cmd.png",
